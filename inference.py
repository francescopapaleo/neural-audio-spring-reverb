...
from sandbox.config import model_params, processing_params, SAMPLE_RATE, INPUT_CH, OUTPUT_CH, MODEL_FILE, AUDIO_DIR
from pathlib import Path
...
def make_inference(input, rt60=True):
    ...
    input_file_path = AUDIO_DIR / input
    x_p, sample_rate = torchaudio.load(input_file_path)
    torchaudio.print_stats(x_p, sample_rate)
