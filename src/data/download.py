...
def download_data(args):
    ...
    if args.dataset == 'springset':
        try:
            ...
            download_file(args.data_dir, "https://zenodo.org/record/3746119/files/plate-spring.zip")
            ...
            (args.data_dir / "spring").rename(args.data_dir / "springset")  # Rename 'spring' to 'springset'
