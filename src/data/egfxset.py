...
def load_egfxset(datadir, batch_size, train_ratio=0.5, valid_ratio=0.25, test_ratio=0.25, num_workers=0):
    ...
    valid_loader = torch.utils.data.DataLoader(valid_data, batch_size, num_workers=num_workers, shuffle=False, drop_last=True, collate_fn=None)
