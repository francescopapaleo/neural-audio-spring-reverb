...
def main():
    ...
    # Optional arguments
    parser.add_argument('--device', type=str, default="auto", choices=["auto", "cuda:0", "cpu"],
    ...
    parser.add_argument('-c', '--checkpoint', type=str, default=None, help='Relative path to the checkpoint file')
